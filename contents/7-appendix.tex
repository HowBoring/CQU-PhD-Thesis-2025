...
% \end{enumerate}
{
    ...
    \item Xiang J , Hou B , Chen X ,et al.House Layout Generation via Diffusion Model with Relative Room Area Ranking[J].2024 International Joint Conference on Neural Networks (IJCNN), 2024.（EI检索）
    \item 
	\end{enumerate}
}
